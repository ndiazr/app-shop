        ...
        <div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h5 class="description">Puedes revisar nuestra relación completa de productos, comparar precios y realizar tus pedidos cuendo estés seguro.</h5>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Atendemos rápidamente cualquier consulta que tengas cía chat. No estás sólo, si no que siempre estamos atentos a tus inquietudes.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
        ...
        <div class="section landing-section">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h4 class="text-center description">Regístrate ingresando tus datos básicos, y podrás realizar tus pedidos a través de nuestro carrito de compras.
                                                        Si aún no te decides, de todas formas, con tu cuenta de usuario podrás hacer tus consultas sin compromiso..</h4>
