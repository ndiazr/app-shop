                    ...
                    <form class="form" method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group">
                                ...
                                <input placeholder="Confirm Password..." id="password-confirm" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password_confirmation" required />
                            </div>
